...
BASE_URL = "https://peru21.pe/deportes"
...
class Command(BaseCommand):
    ...
    def obtener_enlace_noticia(self, noticia_element):
        try:
            link = noticia_element.locator("a[href*='/deportes/']").first
            if link:
    ...
    def handle(self, *args, **kwargs):
        ...
        with sync_playwright() as p:
            ...
            try:
                self.stdout.write("🌐 Navegando a Perú21 - Deportes...")
        ...
        self.stdout.write(self.style.SUCCESS("✅ Scraping de Deportes Perú21 finalizado!"))