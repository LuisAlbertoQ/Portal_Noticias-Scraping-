...
BASE_URL = "https://elcomercio.pe/tecnologia"


class Command(BaseCommand):
    help = 'Scrapea noticias de la sección Tecnologia de El Comercio'
    ...
    def handle(self, *args, **kwargs):
        ...
        with sync_playwright() as p:
            ...
            try:
                self.stdout.write("🌐 Navegando a El Comercio - Tecnologia...")
        ...
        self.stdout.write(self.style.SUCCESS("✅ Scraping de Tecnologia finalizado!"))